...
import { LocationStatus, getStatusLabel, SpaceTypeEnum, getSpaceTypeLabel } from '../../utils';
import { Door, TinyEdit, TinyBin, Monitor, TinyStaff, Qr } from '../../assets/images';
    ...
    <StyledWrapper status={status}>
      ...
      <StyledFooter>
        ...
        <StyledRightBottomContainer>
          <StyledButtonIconQr
            variant='secondary'
            disabled={!(locationFloor?.length > 0)}
            leadingIcon={<Qr />}
            onClick={onClickQr}
          />
