...
import useCreateSpaceAmenity from '../../../../hooks/api/useCreateSpaceAmenity';
...
export default function FeedbackAddSpaceAmenityModal({ onClose, onConfirm }: Props) {
  const { query } = useRouter();
  const mutation = useCreateSpaceAmenity(query.spaceId as string);
